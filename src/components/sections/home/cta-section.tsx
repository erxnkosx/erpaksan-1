  ...
  return (
    <section id="contact" className="bg-white py-24">
      <div className="mx-auto max-w-5xl px-6">
        ...
        {/* CARD */}
        <div className="rounded-3xl bg-[linear-gradient(90deg,#0a1f3d_0%,#123a6b_50%,#0a1f3d_100%)] p-12 text-center text-white shadow-2xl">

          <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#C08A33]">
            Klaar om te starten?
          </p>

          <h2 className="mt-6 mb-6 text-4xl font-black md:text-4xl">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <a
              ...
              className="rounded-xl bg-[#C08A33] px-6 py-4 font-semibold text-white hover:opacity-90 transition"
            >
              Contacteer ons
            </a>
            ...
            <a
              href="#producten"
              className="rounded-xl border border-white/20 bg-white/5 px-6 py-4 font-semibold text-white hover:bg-white hover:text-black transition"
            >
              Bekijk ons aanbod
            </a>
          </div>
